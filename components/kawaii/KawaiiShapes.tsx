 ...
 * KawaiiShapes.tsx
 *
 * This file contains all the minimalist kawaii shapes used throughout the portfolio.
 * Each shape is a simple SVG or div element that can be styled and animated.
...
/**
 * A simple triangle shape using CSS borders
 */
...
/**
 * A star shape using SVG
 */
export const KawaiiStar = ({ className = "", size = 5 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
 ...
 * A snowflake shape
 */
export const KawaiiSnowflake = ({ className = "", size = 20 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
 ...
 * A cloud shape
 */
export const KawaiiCloud = ({ className = "", size = 24 }: SizeProps) => (
  <svg
    width={size}
    height={size * 0.75}
    viewBox="0 0 24 18"
...
/**
 * A sakura (cherry blossom) shape
 */
export const KawaiiSakura = ({ className = "", size = 20 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
 ...
 * A leaf shape
 */
export const KawaiiLeaf = ({ className = "", size = 20 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/**
 * A splash or starburst shape
 */
export const KawaiiSplash = ({ className = "", size = 24 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/**
 * A ripple effect with concentric circles
 */
export const KawaiiRipple = ({ className = "", size = 20 }: SizeProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 20 20"
